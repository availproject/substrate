...
impl<BE, Block: BlockT, C, N, SC, VR> finality_grandpa::Chain<Block::Hash, NumberFor<Block>>
    ...
    NumberFor<Block>: BlockNumberOps,
{
    ...
    fn completed(
        ...
        self.update_voter_set_state(|voter_set_state| {
            ...
            // caught up to.
            let (completed_rounds, current_rounds) = if let VoterSetState::Live {
                completed_rounds,
                current_rounds,
            } = voter_set_state
            {
    ...
    fn concluded(
        ...
        self.update_voter_set_state(|voter_set_state| {
            ...
            if let Some(already_completed) = completed_rounds
                .rounds
                .iter_mut()
